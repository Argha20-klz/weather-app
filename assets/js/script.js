...
// const searchbox = document.getElementById("location_input");
...
//   const url = `https://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=${area}&aqi=yes&alerts=yes&days=7`;
...
searchbox.addEventListener("keyup", (e) => {
  ...
  }, 800); // 500ms delay after the last key press
});
